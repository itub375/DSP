...
das Programm wird mehrmal ausgeführt für verschiedene Interleavete signale zum testen 

NEU: 
        audio_files[] : Array mit mehreren Input signalen
        main()        : Hat jetzt eine schleife für alle Signale in audio_files
"""
import os
import numpy as np
...
class Config:
    # I/O
    INPUT_FILE: str = r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_white_1k_8k_rand.mp3"
...
def plot_results(y: np.ndarray, sr: int, features: Dict, 
                ...
                boundaries: List[float],out_dir : str , segments: List[Tuple[float, float]], 
    ...
    plt.tight_layout()
    out_path = os.path.join(out_dir, "plt")
...
def main(audio_files):
    ...
    for a in audio_files:
        ...
        cfg.INPUT_FILE = a
        cfg.OUT_DIR = "out/output_segment_"+ str(j)
        ...
        plot_results(y, sr, features, change_score, threshold, boundaries, cfg.OUT_DIR,
...
if __name__ == "__main__":
    ...
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_vio_8k_drum_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_vio_8k_jing_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_vio_jingle_rand.mp3",
    
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_white_1k_8k_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_silence_1k_8k_rand.mp3",

    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_30_1k_8k_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_100_1k_8k_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_200_1k_8k_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_500_1k_8k_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_700_1k_8k_rand.mp3",
    r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_1k_8k_20k_rand.mp3",
    #...
    ]
