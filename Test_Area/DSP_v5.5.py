...
nun 1 ms vor und nach WS als deadzone

dafür gibt es neue create_segments methode und neuen attribut DEADZONE_MS sonst alles gleich
...
class Config:
    # I/O
    INPUT_FILE: str = r"C:/eigene Programme/VS_Code_Programme/HKA/DSP/Inputsignale/rand/interleaved_1k_GOD_30sec_rand.mp3"
    OUT_DIR: str = "output_segments"
    
    # Analyse-Parameter
    WINDOW_MS: float = 1.0          # Fenster für Feature-Berechnung (ms)
    ...
    DEADZONE_MS: float = 2.0       # 1 ms vor + 1 ms nach jeder Boundary
